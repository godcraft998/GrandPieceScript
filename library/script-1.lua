-- me finding a devil fruits with devil fruit finder. https://gyazo.com/a3a3c770b737220da82cadf658300224 https://gyazo.com/b551d63b50c7fc9f6aeb3ef609683d86 https://gyazo.com/cb6a5c3b08f440228416cd01f86c3425
...
if 50 > (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - _G.CurrentTarget.HumanoidRootPart.Position).magnitude then
game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(CFrame.new(pos.x, pos.y + 5, pos.z))
...
_G.Speed = 5
To(Vector3.new(pos.x, pos.y, pos.z))
_G.Speed = bruh2
end
end
end
...
test.CFrame = CFrame.new(game.Players.LocalPlayer.Character.RightFoot.Position.x, game:GetService("Players").LocalPlayer.Character.RightFoot.CFrame.y + _G.ting, game.Players.LocalPlayer.Character.RightFoot.Position.z)
test.Size = Vector3.new(game:GetService("Players").LocalPlayer.Backpack.WaterLogia["Hie-Hie"].floor.Size.x, 0.1, game:GetService("Players").LocalPlayer.Backpack.WaterLogia["Hie-Hie"].floor.Size.z)
wait()
test:Destroy()
end
end
...
pcall(function()
_G.Running1 = false
i = hookfunction(wait, function(v) if _G.Running1 == true then if _G.HookWait ~= true then return i(0.1) else return i(v) end else return i(v) end end)
end)
...
do -- Example UI
	...
	do -- Elements
		...
		Tab4:AddLabel("I plan on adding shipfarm soon(and maybe removing _G.)")
		
		Tab4:AddLabel("discord.gg/SqgAa9Fbft - My discord.")
	...
	for i,v in pairs(game:GetService("Lighting"):GetDescendants()) do
		...
		Tab:AddSwitch("Walk on Air(Ctrl toggle up/float)", function(value999)
        _G.value999 = value999
        if value999 == true then
        air()
        end
		end)
...
To(Vector3.new(_G.ResponseX, 10, _G.ResponseZ))
		...
		local Dropdown3 = Tab5:AddDropdown("NPCs In the Area(Don't use hook wait)", function(NPC)
			if NPC ~= "None" then
			_G.Autofarm = true
			_G.AF = true
			Autofarm(NPC)
...
local Dropdown4 = Tab5:AddDropdown("Auto Quest(Near You; Use No Fall Damage)", function(NPC2)
			if NPC2 ~= "None" then
			_G.Quest1 = true
			Quest(NPC2)
			else
...
wait(5.1)
for i=1,_G.IHighest do
local Number = table.concat({"NPC2", i})
end
end
end)
...
if v.Humanoid.ClassName ~= "Humanoid" then
local Number = table.concat({"NPC2", i})
_G[Number] =  Dropdown4:Add(tostring(v))
end
end
if _G.IHighest ~= nil then
if i > _G.IHighest then
...
Tab5:AddSwitch("Autofarm Barrels(Kinda slow beli; buggy)", function(autobarrel)
        if autobarrel == true then
        _G.AutoBarrel = true
        AutoBarrel()
        elseif autobarrel == false then
        _G.AutoBarrel = false
        end
end)
